...
namespace RealUnits
{
    ...
    public abstract class Unit
    {
        ...
        private static Unit[] allUnitTypes = { millimeters, centimeters, decimeters, meters, inches, feet };
        /// <summary>
        /// Static list of all defined unit types
        /// </summary>
        public static Unit[] AllUnitTypes
        {
            get { return Unit.allUnitTypes; }
        }
        ...
        public static int LongestUnitName
        {
            get
            {
                if (longestUnitName == -1)
                {
                    ...
                    {
                        if (unit.Name.Length > longestUnitName)
                            longestUnitName = unit.Name.Length;
                    }
                }
        ...
        public static int ShortestUnitName
        {
            get
            {
                if (shortestUnitName == -1)
                {
                    ...
                    foreach (var unit in allUnitTypes)
                    {
                        if (unit.Name.Length < shortestUnitName)
                            shortestUnitName = unit.Name.Length;
                    }
                }
